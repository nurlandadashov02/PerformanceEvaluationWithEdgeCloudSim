function [] = plotLocation()
    ...
    for s=1:numOfSimulations
        indexCounter = 1;
        for i=endOfMobileDeviceLoop:-stepOfMobileDeviceLoop:startOfMobileDeviceLoop
            try
                filePath = strcat(folderPath,'/ite',int2str(s),'/SIMRESULT_TWO_TIER_WITH_EO_FUZZY_BASED_',int2str(i),'DEVICES_LOCATION.log');
