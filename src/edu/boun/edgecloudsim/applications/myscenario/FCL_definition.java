...
public final class FCL_definition {
	...
	public final static String memberShipFunctions4 = String.join("\n"
			, "FUNCTION_BLOCK tipper"
			, "VAR_INPUT"
			, "	nearest_edge_uitl : REAL;"
			, "	mobile_uitl : REAL;"
			...
			, "END_FUZZIFY"
			, "DEFUZZIFY offload_decision"
			, "	TERM mobile := (0, 0) (30, 1) (60, 0);"
			, "	TERM nearest_edge := (40, 0) (70, 1) (100, 0);"
			, "	METHOD : LM;"
			, "	DEFAULT := 0;"
			, "END_DEFUZZIFY"
	);

	public final static String fclDefinition4 = String.join("\n"
			, memberShipFunctions4
			, "RULEBLOCK No1"
			, "	AND : MIN;"
			, "	ACT : MIN;"
			, "	ACCU : MAX;"
			, " RULE 1 :   IF nearest_edge_uitl IS low AND mobile_uitl IS low AND wlan_delay IS high THEN offload_decision IS mobile;"
			, " RULE 2 :   IF nearest_edge_uitl IS low AND mobile_uitl IS low AND wlan_delay IS medium THEN offload_decision IS mobile;"
			, " RULE 3 :   IF nearest_edge_uitl IS low AND mobile_uitl IS low AND wlan_delay IS low THEN offload_decision IS mobile;"
			, " RULE 4 :   IF nearest_edge_uitl IS low AND mobile_uitl IS medium AND wlan_delay IS high THEN offload_decision IS mobile;"
			, " RULE 5 :   IF nearest_edge_uitl IS low AND mobile_uitl IS medium AND wlan_delay IS medium THEN offload_decision IS mobile;"
			, " RULE 6 :   IF nearest_edge_uitl IS low AND mobile_uitl IS medium AND wlan_delay IS low THEN offload_decision IS nearest_edge;"
			, " RULE 7 :   IF nearest_edge_uitl IS low AND mobile_uitl IS high AND wlan_delay IS high THEN offload_decision IS nearest_edge;"
			, " RULE 8 :   IF nearest_edge_uitl IS low AND mobile_uitl IS high AND wlan_delay IS medium THEN offload_decision IS nearest_edge;"
			, " RULE 9 :   IF nearest_edge_uitl IS low AND mobile_uitl IS high AND wlan_delay IS low THEN offload_decision IS nearest_edge;"
			, " RULE 10 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS low AND wlan_delay IS high THEN offload_decision IS mobile;"
			, " RULE 11 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS low AND wlan_delay IS medium THEN offload_decision IS mobile;"
			, " RULE 12 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS low AND wlan_delay IS low THEN offload_decision IS mobile;"
			, " RULE 13 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS medium AND wlan_delay IS high THEN offload_decision IS mobile;"
			, " RULE 14 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS medium AND wlan_delay IS medium THEN offload_decision IS mobile;"
			, " RULE 15 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS medium AND wlan_delay IS low THEN offload_decision IS nearest_edge;"
			, " RULE 16 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS high AND wlan_delay IS high THEN offload_decision IS nearest_edge;"
			, " RULE 17 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS high AND wlan_delay IS medium THEN offload_decision IS nearest_edge;"
			, " RULE 18 :  IF nearest_edge_uitl IS medium AND mobile_uitl IS high AND wlan_delay IS low THEN offload_decision IS nearest_edge;"
			, " RULE 19 :  IF nearest_edge_uitl IS high AND mobile_uitl IS low AND wlan_delay IS high THEN offload_decision IS mobile;"
			, " RULE 20 :  IF nearest_edge_uitl IS high AND mobile_uitl IS low AND wlan_delay IS medium THEN offload_decision IS mobile;"
			, " RULE 21 :  IF nearest_edge_uitl IS high AND mobile_uitl IS low AND wlan_delay IS low THEN offload_decision IS mobile;"
			, " RULE 22 :  IF nearest_edge_uitl IS high AND mobile_uitl IS medium AND wlan_delay IS high THEN offload_decision IS mobile;"
			, " RULE 23 :  IF nearest_edge_uitl IS high AND mobile_uitl IS medium AND wlan_delay IS medium THEN offload_decision IS mobile;"
			, " RULE 24 :  IF nearest_edge_uitl IS high AND mobile_uitl IS medium AND wlan_delay IS low THEN offload_decision IS nearest_edge;"
			, " RULE 25 :  IF nearest_edge_uitl IS high AND mobile_uitl IS high AND wlan_delay IS high THEN offload_decision IS nearest_edge;"
			, " RULE 26 :  IF nearest_edge_uitl IS high AND mobile_uitl IS high AND wlan_delay IS medium THEN offload_decision IS nearest_edge;"
			, " RULE 27 :  IF nearest_edge_uitl IS high AND mobile_uitl IS high AND wlan_delay IS low THEN offload_decision IS nearest_edge;"
			, "END_RULEBLOCK"
			, "END_FUNCTION_BLOCK"
	);
}
