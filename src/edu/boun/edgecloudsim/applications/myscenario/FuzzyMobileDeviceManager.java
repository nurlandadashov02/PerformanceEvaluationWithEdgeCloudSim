...
//		SimLogger.printLine(ev.toString());
...
//		SimLogger.printLine(String.valueOf(edgeTask.getTaskType()));
		int vmType=0;
		int nextEvent=0;
...
//			SimLogger.printLine("MOBILE TASKSS");
		...
		if(delay>0 || nextHopId == SimSettings.MOBILE_DATACENTER_ID){
			...
			if(selectedVM != null){
				...
				if(!(selectedVM instanceof MobileVM)) {
